 ...
 * @author mdsaz
 */
public class StFF extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (Name.equals(" ") || ID.equals(" ") || Phn.equals("") || Quli.equals(" ") || Dob.equals("") || Add.equals("") || pass.equals("") || gen.equals("") || selary.equals("")) {
            ...
            try {
                Class.forName("com.mysql.cj.jdbc.Driver");
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/schoolmanegmentsytem", "root", "");
                String sql = "INSERT INTO `stuff`( `Name`,`ID`,  `Phone`, `Qulifecation`, `DOB`, `Address`, `Password`, `Selary`, `Gender`) VALUES  (?,?,?,?,?,?,?,?,? )";
                PreparedStatement pst = con.prepareStatement(sql);
                ...
                Logger.getLogger(StFF.class.getName()).log(Level.SEVERE, null, ex);
            } catch (SQLException ex) {
                Logger.getLogger(StFF.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StFF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
